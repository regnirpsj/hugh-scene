...
/**************************************************************************************************/
/*                                                                                                */
/*  module     :  hugh/scene/object/material/simple.hpp                                           */
/*  project    :                                                                                  */
/*  description:                                                                                  */
/*                                                                                                */
/**************************************************************************************************/

#if !defined(HUGH_SCENE_OBJECT_MATERIAL_SIMPLE_HPP)

#define HUGH_SCENE_OBJECT_MATERIAL_SIMPLE_HPP
  ...
  namespace scene {
    ...
    namespace object {
      ...
      namespace material {
        ...
        class HUGH_SCENE_EXPORT simple : public base {
        ...
        public:
          ...
          static simple const dflt_material;
          ...
          explicit simple(rep const& /* material rep */ = rep());
        ...
        HUGH_SCENE_EXPORT bool operator==(simple::rep const&, simple::rep const&);

        HUGH_SCENE_EXPORT std::ostream& operator<<(std::ostream&, simple::rep const&);
...
#endif // #if !defined(HUGH_SCENE_OBJECT_MATERIAL_SIMPLE_HPP)
